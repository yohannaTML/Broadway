...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public MyAdapter(List<Musical> myDataset) {
        values = myDataset;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        Musical selectedMusical = values.get(position);
        final String title = selectedMusical.getTitle();
